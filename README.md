...
| --------------------------------------------- | -------------------------------------------------------------------- |
| ![Data Mahasiswa](./screenshots/mahasiswa.jpeg) | ![Create Edit Data Mahasiswa](./screenshots/create-edit-mahasiswa.png) |

| Export/Import from/to XLSX                                       |                                                                                   |
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| Export/Import Data Mahasiswa & User                               | Export/Import Data Mahasiswa & User + Preview Data                                 |
| ![Export/Import Data Mahasiswa](./screenshots/export-user.jpeg)   | ![Export/Import Data Mahasiswa + Preview](./screenshots/export-user-preview.jpeg)  |
