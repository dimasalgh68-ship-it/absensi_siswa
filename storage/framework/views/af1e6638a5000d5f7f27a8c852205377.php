<div>
  <?php if (! $__env->hasRenderedOnce('9e7be879-1b80-4ad6-ae0c-e9e1215f1f31')): $__env->markAsRenderedOnce('9e7be879-1b80-4ad6-ae0c-e9e1215f1f31');
$__env->startPush('styles'); ?>
  ...
  <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
    <div class="flex items-center gap-4">
        <a href="<?php echo e(route('home')); ?>" class="group flex items-center justify-center w-10 h-10 rounded-xl bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all">
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-4 mb-8">
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 p-4 text-white shadow-lg shadow-green-500/20">
          ...
          <div class="relative z-10">
              ...
              <div class="flex items-end gap-2 mt-1">
                  <h4 class="text-3xl font-black"><?php echo e($presentCount + $lateCount); ?></h4>
                  <span class="text-xs bg-white/20 px-1.5 py-0.5 rounded text-white mb-1.5"><?php echo e($lateCount); ?> Telat</span>
              </div>
          </div>
      </div>
      ...
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 p-4 text-white shadow-lg shadow-blue-500/20">
          ...
          <div class="relative z-10">
              ...
              <h4 class="text-3xl font-black mt-1"><?php echo e($excusedCount); ?></h4>
          </div>
      </div>
      ...
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500 to-fuchsia-600 p-4 text-white shadow-lg shadow-purple-500/20">
          ...
          <div class="relative z-10">
              ...
              <h4 class="text-3xl font-black mt-1"><?php echo e($sickCount); ?></h4>
          </div>
      </div>
      ...
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-red-500 to-rose-600 p-4 text-white shadow-lg shadow-red-500/20">
          ...
          <div class="relative z-10">
              ...
              <h4 class="text-3xl font-black mt-1"><?php echo e($absentCount); ?></h4>
          </div>
      </div>
  </div>
        ...
        <div class="min-w-[600px]">
            <div class="grid grid-cols-7 gap-2 mb-2">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = ['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center text-xs font-semibold text-gray-400 uppercase tracking-wider py-2 <?php echo e($day === 'Min' ? 'text-red-400' : ''); ?> <?php echo e($day === 'Jum' ? 'text-green-600 dark:text-green-400' : ''); ?>">
                        <?php echo e($day); ?>
            ...
            <div class="grid grid-cols-7 gap-2">
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($attendance && ($attendance['attachment'] || $attendance['note'] || $attendance['coordinates'])): ?>
                        <button wire:click="show(<?php echo e($attendance['id']); ?>)" onclick="setLocation(<?php echo e($attendance['lat'] ?? 0); ?>, <?php echo e($attendance['lng'] ?? 0); ?>)" class="<?php echo e($baseClasses); ?> <?php echo e($statusClasses); ?>">
                            <span class="<?php echo e($date->isSunday() ? 'text-red-500' : ''); ?>"><?php echo e($date->format('d')); ?></span>
                            <!--[if BLOCK]><![endif]--><?php if($dotClass): ?>
                                <span class="w-1.5 h-1.5 rounded-full <?php echo e($dotClass); ?> mt-1"></span>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </button>
                    <?php else: ?>
                        <div class="<?php echo e($baseClasses); ?> <?php echo e($statusClasses); ?>">
                            <span class="<?php echo e($date->isSunday() ? 'text-red-500' : ''); ?>"><?php echo e($date->format('d')); ?></span>
                            <!--[if BLOCK]><![endif]--><?php if($dotClass): ?>
                                <span class="w-1.5 h-1.5 rounded-full <?php echo e($dotClass); ?> mt-1"></span>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH C:\laragon\www\absensi-siswa\resources\views/livewire/attendance-history.blade.php ENDPATH**/ ?>