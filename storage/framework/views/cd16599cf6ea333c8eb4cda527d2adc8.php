    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" style="padding-top: 70px;">
                ...
                <!-- Topbar -->
                <?php echo $__env->make('layouts.partials.admin-topbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <!-- End of Topbar -->
            ...
            <footer class="bg-white py-4 border-top">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto text-muted small">
                        <span>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> • Developed with <i class="fas fa-heart text-danger"></i></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 420px;">
            <div class="modal-content border-0 overflow-hidden" style="border-radius: 1.25rem; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25);">
                ...
                <div style="margin: -1.5rem 1.5rem 0; position: relative; z-index: 1;">
                    <div style="background: white; border-radius: 1rem; padding: 0.85rem 1rem; display: flex; align-items: center; gap: 0.75rem; box-shadow: 0 8px 24px rgba(0,0,0,0.08); border: 1px solid #f1f5f9;">
                        ...
                        <div style="overflow: hidden; flex: 1;">
                            <div style="font-weight: 700; color: #1e293b; font-size: 0.9rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e(Auth::user()->name); ?></div>
                            <div style="color: #94a3b8; font-size: 0.72rem;"><?php echo e(Auth::user()->email); ?></div>
                        </div>
                        <span style="background: <?php echo e(Auth::user()->isTeacher ? 'rgba(5,150,105,0.1)' : 'rgba(79,70,229,0.1)'); ?>; color: <?php echo e(Auth::user()->isTeacher ? '#059669' : '#4f46e5'); ?>; border-radius: 20px; padding: 0.2rem 0.6rem; font-size: 0.65rem; font-weight: 700; white-space: nowrap;">
                            <?php echo e(Auth::user()->isTeacher ? 'Guru' : 'Admin'); ?>
                ...
                <div style="padding: 1rem 1.5rem 1.5rem; display: flex; gap: 0.75rem;">
                    ...
                    <a href="<?php echo e(route('logout.confirm')); ?>"
...
<?php /**PATH D:\PROJECT-LARAVEL\absensi-siswa\absensi-siswa\resources\views/layouts/admin.blade.php ENDPATH**/ ?>