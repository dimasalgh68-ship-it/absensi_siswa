...
?>
<div>
<?php if (! $__env->hasRenderedOnce('fd444142-b238-4aaf-9413-ff2cbed837f3')): $__env->markAsRenderedOnce('fd444142-b238-4aaf-9413-ff2cbed837f3');
    ...
    <div class="col-12">
        <div class="card border-0 shadow-premium rounded-2xl overflow-hidden bg-gradient-primary text-white p-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    <h2 class="font-weight-bold mb-1">Selamat Datang Kembali, <?php echo e(Auth::user()->name); ?>! 👋</h2>
                ...
                <div class="mt-3 mt-md-0">
                    <span class="badge badge-pill bg-white text-primary font-weight-bold px-3 py-2">
                        <i class="fas fa-calendar-day mr-1"></i> <?php echo e($date->translatedFormat('l, d F Y')); ?>
            ...
            <div class="card-body p-4" style="border-left: 5px solid #10b981;">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($presentCount); ?></div>
                        <div class="text-xs text-muted mt-1 font-weight-500">Terlambat: <?php echo e($lateCount); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body p-4" style="border-left: 5px solid #3b82f6;">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($excusedCount + $sickCount); ?></div>
                        <div class="text-xs text-muted mt-1 font-weight-500">Izin: <?php echo e($excusedCount); ?> | Sakit: <?php echo e($sickCount); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body p-4" style="border-left: 5px solid #ef4444;">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($absentCount); ?></div>
            ...
            <div class="card-body p-4" style="border-left: 5px solid #f59e0b;">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h3 mb-0 font-weight-bold text-gray-800"><?php echo e($employeesCount); ?></div>
...
<div class="row mb-4">
    <div class="col-xl-4 col-md-6 mb-4">
        <a href="<?php echo e(route('admin.masters.admin')); ?>" class="text-decoration-none hover-translate-y transition-all d-block">
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="font-weight-bold text-slate-800 mb-0"><?php echo e($teachersCount); ?></h3>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
        <a href="<?php echo e(route('admin.face-registrations')); ?>" class="text-decoration-none hover-translate-y transition-all d-block">
            <div class="card border-0 shadow-premium rounded-2xl overflow-hidden bg-white">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-slate-600 font-weight-bold mb-1">Face Registration</h6>
                            <h3 class="font-weight-bold text-slate-800 mb-0"><?php echo e($faceRegCount); ?></h3>
    ...
    <div class="col-xl-4 col-md-12 mb-4">
        <a href="<?php echo e(route('admin.office-locations')); ?>" class="text-decoration-none hover-translate-y transition-all d-block">
            <div class="card border-0 shadow-premium rounded-2xl overflow-hidden bg-white">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-slate-600 font-weight-bold mb-1">Titik GPS Lokasi</h6>
                            <h3 class="font-weight-bold text-slate-800 mb-0"><?php echo e($officeLocCount); ?></h3>
    ...
    <div class="col-lg-7 mb-4">
        <div class="card border-0 shadow-premium rounded-2xl overflow-hidden mb-4">
            <div class="card-header bg-white py-3 border-bottom-light d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-calendar-alt mr-2"></i>Jadwal Hari Ini (<?php echo e($todayDayName); ?>)</h6>
                <a href="<?php echo e(route('admin.schedules')); ?>" class="small font-weight-bold">Semua Jadwal &rarr;</a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-items-center mb-0" style="width: 100%;">
                        ...
                        <tbody class="text-slate-800 font-weight-500">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $todaySchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="font-weight-600 text-slate-800"><?php echo e($sch->subject->name ?? 'N/A'); ?></div>
                                        <small class="text-slate-600"><?php echo e($sch->education->name ?? 'N/A'); ?></small>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="font-weight-600 text-slate-700"><?php echo e($sch->room ?? '-'); ?></div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="small text-slate-600"><?php echo e($sch->teacher->name ?? 'N/A'); ?></div>
                                    </td>
                                </tr>
        ...
        <div class="card border-0 shadow-premium rounded-2xl overflow-hidden">
            <div class="card-header bg-white py-3 border-bottom-light d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('admin.tasks')); ?>" class="small font-weight-bold">Semua Tugas &rarr;</a>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover align-items-center mb-0" style="width: 100%;">
                        ...
                        <tbody class="text-slate-800 font-weight-500">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-4 py-3">
                                        <div class="font-weight-600 text-slate-800"><?php echo e($task->title); ?></div>
                                        <small class="text-slate-600"><?php echo e(Str::limit($task->description, 50)); ?></small>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="small text-danger font-weight-600"><?php echo e(\Carbon\Carbon::parse($task->due_date)->translatedFormat('d M, H:i')); ?></div>
                                    </td>
                                    <td class="px-4 py-3 text-right">
                                        <a href="<?php echo e(route('admin.tasks.show', $task)); ?>" class="btn btn-light btn-sm rounded-xl px-3 hover-translate-y transition-all">Detail</a>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                ...
                <div class="card-body p-4 d-flex flex-col justify-content-between">
                    <div>
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                <h6 class="font-weight-bold text-slate-800 mb-1">Shift Aktif: <?php echo e($shift->name); ?></h6>
                                <p class="text-muted extra-small mb-0">Waktu Kerja: <?php echo e($shift->start_time); ?> - <?php echo e($shift->end_time); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-2xl p-3 mb-4 bg-slate-50">
                            <div class="row text-center">
                                <div class="col-4">
                                    ...
                                    <span class="font-weight-bold text-success"><?php echo e(\Carbon\Carbon::parse($shift->start_time)->subMinutes((int) \App\Models\Setting::get('clock_in_early_minutes', 60))->format('H:i')); ?></span>
                                </div>
                                <div class="col-4 border-left border-right">
                                    <small class="text-muted d-block mb-1">Batas Telat</small>
                                    <span class="font-weight-bold text-danger"><?php echo e(\Carbon\Carbon::parse($shift->start_time)->addMinutes((int) \App\Models\Setting::get('clock_in_late_minutes', 120))->format('H:i')); ?></span>
                                </div>
                                <div class="col-4">
                                    <small class="text-muted d-block mb-1">Jam Keluar</small>
                                    <span class="font-weight-bold text-primary"><?php echo e(\Carbon\Carbon::parse($shift->end_time)->format('H:i')); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-hover align-items-center mb-0" style="width: 100%;">
                        ...
                        <tbody class="text-slate-800 font-weight-500">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <tr wire:key="<?php echo e($employee->id); ?>">
                                    <td class="px-4 py-3">
                                        <div class="font-weight-600 text-slate-800"><?php echo e($employee->name); ?></div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="text-slate-600"><?php echo e($employee->nisn); ?></div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="font-weight-600 text-slate-700"><?php echo e($employee->education?->name ?? '-'); ?></div>
                                        <small class="text-slate-600"><?php echo e($employee->jobTitle?->name ?? '-'); ?></small>
                                    </td>
                                    <td class="px-4 py-3">
                                        <span class="badge badge-pill font-weight-bold px-3 py-2 <?php echo e($badgeClass); ?>">
                                            <?php echo e($statusText); ?>

                                        </span>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="text-slate-700"><?php echo e($timeIn ?? '-'); ?></div>
                                    </td>
                                    <td class="px-4 py-3">
                                        <div class="text-slate-700"><?php echo e($timeOut ?? '-'); ?></div>
                                    </td>
                                    <td class="px-4 py-3 text-right">
                                        <!--[if BLOCK]><![endif]--><?php if($attendance && ($attendance->attachment || $attendance->note || $attendance->lat_lng)): ?>
                                            <button type="button" class="btn btn-light btn-sm rounded-xl px-3 hover-translate-y transition-all" 
                                                    ...
                                                    onclick="setLocation(<?php echo e($attendance->latitude ?? 0); ?>, <?php echo e($attendance->longitude ?? 0); ?>)">
...
<?php /**PATH D:\PROJECT-LARAVEL\absensi-siswa\absensi-siswa\resources\views/livewire/admin/dashboard.blade.php ENDPATH**/ ?>