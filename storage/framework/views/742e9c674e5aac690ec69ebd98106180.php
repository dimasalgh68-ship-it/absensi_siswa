...
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center py-1 pt-3" href="<?php echo e(route($routePrefix . '.dashboard')); ?>">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.dashboard') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.dashboard')); ?>">
    ...
    <!-- Nav Item - Attendance -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.attendances*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.attendances')); ?>">
    ...
    <!-- Nav Item - Employees -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.employees*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.employees')); ?>">
    ...
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.teachers*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.teachers')); ?>">
    ...
    <li class="nav-item <?php echo e(request()->routeIs('admin.teacher-subjects') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route('admin.teacher-subjects')); ?>">
    ...
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.academic-calendar') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.academic-calendar')); ?>">
    ...
    <!-- Nav Item - Materi -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.materials*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.materials')); ?>">
    ...
    <!-- Nav Item - Tugas -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.tasks*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.tasks')); ?>">
    ...
    <!-- Nav Item - Jadwal -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.schedules*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.schedules')); ?>">
    ...
    <!-- Nav Item - Ujian CBT -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.exams*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.exams')); ?>">
    ...
    <!-- Nav Item - Nilai -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.grades*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.grades')); ?>">
    ...
    <!-- Nav Item - Raport -->
    <li class="nav-item <?php echo e(request()->routeIs($routePrefix . '.report-cards*') ? 'active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(route($routePrefix . '.report-cards')); ?>">
    ...
    <li class="nav-item <?php echo e(request()->routeIs('admin.masters.*') ? 'active' : ''); ?>" 
        ...
        <div x-show="open" 
            ...
            <div class="rounded-xl py-2" style="background: rgba(255,255,255,0.03);">
                ...
                <a class="sub-nav-link <?php echo e(request()->routeIs('admin.masters.subject') ? 'active' : ''); ?>" href="<?php echo e(route('admin.masters.subject')); ?>">Mata Pelajaran</a>
...
<?php /**PATH D:\PROJECT-LARAVEL\absensi-siswa\absensi-siswa\resources\views/layouts/partials/admin-sidebar.blade.php ENDPATH**/ ?>