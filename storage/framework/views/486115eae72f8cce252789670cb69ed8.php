...
<div class="relative" x-data="{ dropdownOpen: false }" @click.away="dropdownOpen = false" @close.stop="dropdownOpen = false">
    <div @click="dropdownOpen = ! dropdownOpen" class="select-none">
        <?php echo e($trigger); ?>
...
<?php /**PATH C:\laragon\www\absensi-siswa\resources\views/components/dropdown.blade.php ENDPATH**/ ?>