          ...
          <div class="group">
            <div class="flex justify-between items-center ml-1 mb-2">
              ...
              <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="text-[11px] font-bold text-blue-500 hover:text-blue-700 transition-colors">
                  LUPA PASSWORD?
                </a>
              <?php endif; ?>
            </div>
        ...
        <?php if(Route::has('register')): ?>
          <div class="mt-12 text-center pb-6 sm:pb-0">
            <p class="text-sm font-semibold text-gray-500 dark:text-gray-400">
              Belum punya akun? 
              <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:text-blue-800 ml-1 font-bold">Daftar di sini</a>
            </p>
          </div>
        <?php endif; ?>
      </div>
...
<?php endif; ?>
<?php /**PATH D:\PROJECT-LARAVEL\absensi-siswa\absensi-siswa\resources\views/auth/login.blade.php ENDPATH**/ ?>