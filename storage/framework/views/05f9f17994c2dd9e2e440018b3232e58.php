        ...
        <li class="nav-item dropdown no-arrow" x-data="{ open: false }" @click.away="open = false">
            <button type="button" 
                ...
                <div class="text-right mr-3 d-none d-lg-inline">
                    ...
                    <span class="text-slate-400 extra-small font-weight-600"><?php echo e(Auth::user()->isTeacher ? 'Tenaga Pendidik' : 'Administrator'); ?></span>
                </div>
            ...
            <div x-show="open" 
                ...
                <div class="dropdown-items">
                    <a class="dropdown-item rounded-xl py-2 px-3 d-flex align-items-center transition-all hover-translate-x" href="<?php echo e(route(Auth::user()->isTeacher ? 'teacher.profile' : 'admin.profile')); ?>">
...
<?php /**PATH D:\PROJECT-LARAVEL\absensi-siswa\absensi-siswa\resources\views/layouts/partials/admin-topbar.blade.php ENDPATH**/ ?>