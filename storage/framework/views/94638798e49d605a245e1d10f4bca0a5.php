      ...
      <div class="relative min-h-screen sm:min-h-[auto] w-full px-6 py-12 sm:px-10 sm:py-16 bg-white dark:bg-gray-900 sm:rounded-[40px] shadow-none sm:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.08)] border-0 sm:border border-gray-100 dark:border-gray-800 flex flex-col justify-center">
        ...
        <div class="flex flex-col items-center justify-center mb-10 text-center select-none">
          <div class="relative group">
            ...
            <?php if(\App\Models\Setting::logo()): ?>
              <div class="relative bg-white dark:bg-gray-800 p-2 rounded-2xl shadow-sm">
                <img src="<?php echo e(\App\Models\Setting::logo()); ?>" alt="Logo" class="w-16 h-16 sm:w-20 sm:h-20 object-contain">
              </div>
            <?php else: ?>
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="group">
              ...
              <input id="nisn" type="text" name="nisn" value="<?php echo e(old('nisn')); ?>" autocomplete="nisn" required
            ...
            <div class="group">
              ...
              <select id="education_id" name="education_id" required
                ...
                <?php $__currentLoopData = \App\Models\Education::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $education): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($education->id); ?>" <?php echo e(old('education_id') == $education->id ? 'selected' : ''); ?>>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.checkbox','data' => ['name' => 'terms','id' => 'terms','required' => true,'class' => 'w-5 h-5 rounded-md border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'terms','id' => 'terms','required' => true,'class' => 'w-5 h-5 rounded-md border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="ms-3 text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                  <?php echo __('Saya setuju dengan :terms_of_service dan :privacy_policy', [
        ...
        <div class="mt-12 text-center pb-6 sm:pb-0">
          <p class="text-sm font-semibold text-gray-500 dark:text-gray-400">
            Sudah punya akun? 
            <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-800 ml-1 font-bold">Masuk di sini</a>
          </p>
        </div>
      </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\absensi-siswa\resources\views/auth/register.blade.php ENDPATH**/ ?>