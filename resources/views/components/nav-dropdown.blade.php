...
<div {{ $attributes->merge(['class' => $classes]) }} x-data="{ dropdownOpen: false }" @click.away="dropdownOpen = false"
  @close.stop="dropdownOpen = false">
  <div @click="dropdownOpen = ! dropdownOpen" class="{{ $triggerClasses }} flex h-full items-center select-none">
    {{ $trigger }}
  </div>
  <div class="relative">
    <div x-show="dropdownOpen" 
         ...
         class="{{ $alignmentClasses }} {{ $dropdownClasses }} absolute z-[100] mt-2 rounded-md shadow-lg"
         style="display: none;" 
