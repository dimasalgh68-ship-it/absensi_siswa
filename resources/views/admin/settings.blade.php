<x-admin-layout>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.settings.update-app-name') }}" method="POST">
                @csrf
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="border rounded p-4 text-center bg-light">
                        @if($logo)
                            ...
                            <br>
                            <form action="{{ route('admin.settings.reset-logo') }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" 
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.settings.update-attendance') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('clock_in_early_minutes', $clockInEarlyMinutes ?? 60) }}"
                                   min="0"
                                   class="form-control"
                                   required>
                            @error('clock_in_early_minutes')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                            <small class="form-text text-muted">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('clock_in_late_minutes', $clockInLateMinutes ?? 120) }}"
                                   min="0"
                                   class="form-control"
                                   required>
                            @error('clock_in_late_minutes')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                            <small class="form-text text-muted">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('late_tolerance_minutes', $lateToleranceMinutes) }}"
                                   min="0"
                                   class="form-control"
                                   required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('clock_out_early_minutes', $clockOutEarlyMinutes) }}"
                                   min="0"
                                   class="form-control"
                                   required>
                            @error('clock_out_early_minutes')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                            <small class="form-text text-muted">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.settings.update-face-recognition') }}" method="POST">
                @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" 
                                       ...
                                       value="{{ old('face_similarity_threshold', $faceSimilarityThreshold ?? 70) }}"
                                       min="50"
                                       max="95"
                                       step="1"
                                       class="form-control"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress" style="height: 30px;">
                                <div id="threshold-bar" class="progress-bar progress-bar-striped progress-bar-animated" 
                                     role="progressbar" 
                                     style="width: {{ $faceSimilarityThreshold ?? 70 }}%"
                                     aria-valuenow="{{ $faceSimilarityThreshold ?? 70 }}" 
                                     aria-valuemin="0" 
                                     aria-valuemax="100">
                                    <span id="threshold-text" class="font-weight-bold">{{ $faceSimilarityThreshold ?? 70 }}%</span>
                                </div>
                            </div>
                            <div class="d-flex justify-content-between mt-2">
                                <small class="text-muted">Rendah (50%)</small>
                                <small id="threshold-label" class="font-weight-bold text-primary">
                                    @if(($faceSimilarityThreshold ?? 70) < 65)
                                        Rendah
                                    @elseif(($faceSimilarityThreshold ?? 70) < 80)
                                        Sedang
                                    @else
                                        Tinggi
                                    @endif
