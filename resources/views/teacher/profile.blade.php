<x-teacher-layout>
    <x-slot name="title">Profil Guru</x-slot>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-2 text-gray-800 font-weight-bold">
                    <i class="fas fa-user-circle text-emerald-600 mr-2"></i>Profil Saya
                </h1>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card shadow-sm border-0 rounded-2xl">
                    <div class="card-body text-center p-4">
                        ...
                        <div class="mb-4 position-relative d-inline-block">
                            ...
                            @else
                                <div class="rounded-circle shadow-lg d-flex align-items-center justify-content-center text-white font-weight-bold mx-auto"
                                     style="width: 120px; height: 120px; background: linear-gradient(135deg, #059669 0%, #10b981 100%); font-size: 3rem;">
                        ...
                        <span class="badge px-3 py-2 rounded-pill" style="font-size: 0.75rem; background: rgba(5, 150, 105, 0.1); color: #059669;">
                        ...
                        <div class="row text-center">
                            <div class="col-6 border-right">
                                <div class="text-emerald-600 font-weight-bold h4 mb-1">{{ Auth::user()->created_at->diffInDays(now()) }}</div>
                ...
                <div class="card shadow-sm border-0 rounded-2xl mt-4">
                    <div class="card-body p-4">
                        <h6 class="font-weight-bold text-gray-800 mb-3">
                            <i class="fas fa-id-card text-emerald-600 mr-2"></i>Data Guru
                        </h6>
                        @if($teacher)
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="font-weight-600 text-gray-700">
                                    {{ $teacher->specialization ?? 'Belum diisi' }}
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    @elseif($teacher->status === 'on_leave')
                                        <span class="badge badge-warning px-3 py-2">Cuti</span>
                                    @else
                            ...
                            <div>
                                <small class="text-muted d-block mb-1">Nomor Sertifikat</small>
                                <div class="font-weight-600 text-gray-700">
                                    {{ $teacher->certification_number ?? 'Belum diisi' }}
                                </div>
                            </div>
                        @else
                            <div class="alert alert-info mb-0">
                                <i class="fas fa-info-circle mr-2"></i>
                                Data guru belum tersedia. Hubungi administrator.
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0 rounded-2xl mt-4">
                    <div class="card-body p-4">
                        <h6 class="font-weight-bold text-gray-800 mb-3">
                            <i class="fas fa-info-circle text-emerald-600 mr-2"></i>Informasi Akun
                        </h6>
                        <div class="mb-3">
                    ...
                    <div class="card shadow-sm border-0 rounded-2xl mb-4">
                        <div class="card-header bg-white border-0 py-3">
                            <h6 class="font-weight-bold text-gray-800 mb-0">
                                <i class="fas fa-user-edit text-emerald-600 mr-2"></i>Informasi Profil
                            </h6>
                        </div>
                        <div class="card-body p-4">
