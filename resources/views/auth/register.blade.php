            ...
            <div class="group">
              ...
              <div class="relative">
                <input id="password" type="password" name="password" required autocomplete="new-password"
                  placeholder="••••••••"
                  class="w-full bg-gray-50 dark:bg-gray-800 border-2 border-gray-50 dark:border-gray-800 px-5 py-3.5 pr-12 rounded-2xl text-base outline-none focus:border-blue-500/30 focus:bg-white dark:focus:bg-gray-900 transition-all duration-300 text-gray-700 dark:text-white placeholder:text-gray-300 shadow-sm" />
                <button
                  type="button"
